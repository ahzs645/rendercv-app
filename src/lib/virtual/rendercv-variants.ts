...
export const defaultDesigns = {classic:`design:
  theme: classic
  page:
    size: us-letter
    top_margin: 0.7in
...
export const defaultLocales = {english:`locale:
  language: english
...
export const themes = ["classic","engineeringclassic","engineeringresumes","moderncv","sb2nov"];
