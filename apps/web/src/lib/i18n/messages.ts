...
export const en = {
  ...
  'tour.createImport.title': 'Create & Import',
  'tour.createImport.body': 'Start by creating a new CV from scratch or importing existing YAML/PDF content. The assistant can help turn rough content into a polished CV.',
  'tour.editor.title': 'Editor',
  'tour.editor.body': 'This is where you edit your CV content. Switch between the visual form editor and YAML using the toolbar.',
  'tour.sectionTabs.title': 'Section Tabs',
  'tour.sectionTabs.body': 'Switch between CV, Design, Locale, and Settings. Each tab customizes a different part of your resume.',
  'tour.ai.title': 'AI Assistant',
  'tour.ai.body': 'Ask for stronger bullets, section rewrites, or tailoring help for a specific job description.',
  'tour.preview.title': 'Live Preview',
  'tour.preview.body': 'See the rendered CV update as you edit. Zoom in for details or open a popup for side-by-side editing.',
  'tour.share.title': 'Share',
  'tour.share.body': 'Download your CV as a PDF, use native sharing, or generate a link when you are ready to send it.',
  'tour.backup.title': 'Backup & Export',
  'tour.backup.body': 'Export your data as a portable backup. RenderCV keeps your resume content portable instead of locked into the editor.',
...
export const ko: Messages = {
  ...
  'tour.createImport.title': '만들기 및 가져오기',
  'tour.createImport.body': '새 이력서를 처음부터 만들거나, 기존 YAML/PDF 내용을 가져와 시작하세요. 어시스턴트가 거친 내용을 다듬어 줍니다.',
  'tour.editor.title': '편집기',
  'tour.editor.body': '이력서 내용을 편집하는 곳입니다. 도구 모음에서 양식 편집기와 YAML 을 오갈 수 있습니다.',
  'tour.sectionTabs.title': '섹션 탭',
  'tour.sectionTabs.body': '이력서, 디자인, 로케일, 설정 사이를 오갑니다. 각 탭은 이력서의 서로 다른 부분을 다룹니다.',
  'tour.ai.title': 'AI 어시스턴트',
  'tour.ai.body': '더 나은 항목 문구, 섹션 다시 쓰기, 특정 채용 공고에 맞춘 수정을 요청해 보세요.',
  'tour.preview.title': '실시간 미리보기',
  'tour.preview.body': '편집하는 대로 렌더링된 이력서가 갱신됩니다. 확대해서 살펴보거나 별도 창을 열어 나란히 편집할 수 있습니다.',
  'tour.share.title': '공유',
  'tour.share.body': '이력서를 PDF 로 내려받거나, 기기 공유 기능을 쓰거나, 보낼 준비가 되면 링크를 만드세요.',
  'tour.backup.title': '백업 및 내보내기',
  'tour.backup.body': '데이터를 옮길 수 있는 백업으로 내보내세요. RenderCV 는 이력서 내용을 편집기에 가두지 않습니다.',
